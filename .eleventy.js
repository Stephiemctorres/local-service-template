...
module.exports = function (eleventyConfig) {
	...
	/*
	 * 🔒 JSON-safe string filter for inline <script type="application/ld+json">
	 * blocks (structured data / schema.org). Safely escapes quotes, newlines,
	 * etc. so client-entered text (business name, FAQ answers, etc.) can't
	 * break the JSON output. Usage: {{ someValue | jsonSafe | safe }}
	 */
